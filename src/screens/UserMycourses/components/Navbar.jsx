  ...
  <span className=" absolute rounded-full h-2 w-2 bg-red-600"></span>
    ...
    <div className="sm:hidden" id="mobile-menu">
      <div className="space-y-1 px-2 pt-2 pb-3">
        ...
        <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">My Course</a>
  
        <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Browse Course</a>
      </div>
    </div>
  </nav>
  )
